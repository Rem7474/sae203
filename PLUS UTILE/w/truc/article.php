...
if($article){
    ...
    if($idvendeur == $article['refvendeur']){
        ...
        $bouton_modifier = '<a class="button" id="change" href="formulairemodifarticle.php?idproduit='.$id.'">Modifier</a>';
        $bouton_supprimer = '<a class="button" id="delete" href="traitementSupprimerArticle.php?idarticle='.$id.'">Supprimer</a>';
