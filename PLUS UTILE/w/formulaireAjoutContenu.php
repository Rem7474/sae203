...
<html>
	<head>
		<title> Formulaire Saisie de contenu de commandes</title>
		<meta charset="utf-8"/>
	</head>
	<body>
		<center>
			<h1> Formulaire : Saisie de contenu de commandes</h1>
		<form method="GET" action="EnregistreContenu.php">
        &nbsp; <!-- &nbsp; est le code "espace" en html -->
        Identifiant de la commande : &nbsp;
        <?php
        $resultat=ListeCommandes($conn1);
        $resuTab = $resultat->fetchAll();
        print '<select name="P_refCom">';
